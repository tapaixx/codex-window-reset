...
export const simulationFixture = {
  work_minutes: 510,
  baseline: { available_coverage_minutes: 120, idle_window_minutes: 0, timeline_segments: [
    segment('available', '09:00', '10:00'), segment('limited', '10:00', '12:00'),
    segment('break', '12:00', '13:30'), segment('available', '13:30', '14:30'), segment('limited', '14:30', '19:00'),
  ] },
  scheduled: { available_coverage_minutes: 120, idle_window_minutes: 0, timeline_segments: [
    segment('available', '09:00', '10:00'), segment('limited', '10:00', '12:00'),
    segment('break', '12:00', '13:30'), segment('limited', '13:30', '14:00'),
    segment('available', '14:00', '15:00'), segment('limited', '15:00', '19:00'),
  ] },
  net_gain_minutes: 0,
  preheat_windows: [
